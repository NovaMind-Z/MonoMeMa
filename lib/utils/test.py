...
def im_detect(sess, net, im, memory_storex, memory_storey):
    ...
    _, scores, bbox_pred, dis_pre, rois, fc = net.test_image(sess, blobs['data'], blobs['im_info'], memory_storex, memory_storey)

    return scores, bbox_pred, dis_pre, rois, fc
