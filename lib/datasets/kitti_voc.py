...
class kitti_voc(imdb):  # kitti_2012_trainval
    ...
    def _get_default_path(self):
        ...
        """
        return os.path.join(cfg.FLAGS2["data_dir"], 'Kitdevkit' + self._year)
    ...
    def _do_python_eval(self, output_dir='output'):
        annopath = self._devkit_path + '\\KITTI' + self._year + '\\Annotations\\' + '{:s}.xml'
